...
class ViewController: UIViewController {
    ...
    let chooseArticleDropDown = DropDown(searchable: true)
    let amountDropDown = DropDown()
    let chooseDropDown = DropDown(searchable: true)
...
//        appearance.textFont = UIFont(name: "Georgia", size: 14)
    ...
    func setupChooseArticleDropDown() {
        chooseArticleDropDown.placeholder = "Search articles ..."
        chooseArticleDropDown.anchorView = chooseArticleButton
        chooseArticleDropDown.placeholderColor = UIColor.yellow
